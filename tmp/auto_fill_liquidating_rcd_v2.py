...
helper_marker = """  }, [accountabilityRows, accountabilitySearch])

  const updateLine = (id, field, value) => {"""
helper_block = """  }, [accountabilityRows, accountabilitySearch])
...
text = text.replace("""  const updateLiquidatingRow = (id, field, value) => {
...
if load_effect not in text:
    raise SystemExit('load effect not found')
