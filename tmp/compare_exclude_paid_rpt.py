...
paid_this_year AS (
 SELECT DISTINCT c.current_taxtrans_id
...
FROM ledger l
WHERE l.current_taxtrans_id NOT IN (SELECT current_taxtrans_id FROM paid_this_year)
 AND bsc+bpen+sef+spen>0
""")
